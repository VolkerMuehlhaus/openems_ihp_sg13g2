...
try:
    ...
    raise ImportError(
        "The 'shapely' package is required (used for hole/cutout handling in GDSII polygons) "
        "but is not installed in this Python environment. Install it with: pip install shapely"
    ) from e
...
def runSimulation (excite_portnumbers=None, 
    ...
    if not postprocess_only:
        ...
        # the model is unchanged - the preview always reflects the current model.
